...
const Discossions = () => {
  ...
  const { setOpenSideNav, openSideNav, showPPicture } = useWhatSappContext();
  ...
  return (
    <>
      {showPPicture ? (
        <ShowProfilePicture>
          <div className=" w-full h-full bg-white/70 flex flex-col justify-start pt-20  items-center">
            <Image
              src={
