...
const GoogleButton = () => {
  ...
  return (
    <div>
      {/* <>
        <div id="g_id_onload"
          data-client_id="743181202305-k56gg7eego9at61g95m28u9aikihnltv.apps.googleusercontent.com","project_id":"whatsapp-clone-406006"
        data-context="signin"
        data-ux_mode="popup"
        data-login_uri="https://xkwspfurbsmpwwazlkmu.supabase.co"
